    ...
    <div className="flex bg-dark-layer-1 absolute bottom-0 z-10 w-full">
      <div className="mx-5 my-[10px] flex justify-between w-full">
        ...
        <div className="ml-auto flex items-center space-x-4">
          ...
          <button className="px-3 py-1.5 font-medium items-center transition-all focus:outline-none inline-flex text-sm text-foreground bg-dark-green-s hover:bg-green-3 rounded-lg">
            Submit
          </button>
        </div>
      </div>
