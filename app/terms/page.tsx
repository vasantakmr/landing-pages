  ...
  return (
    <div className="w-full flex flex-col justify-center items-center p-5">
      <div className="max-w-7xl">
        ...
        <p>
          The site design, logo and video content subject to copyright ©
          2022-present | GuruCodes LLC
        </p>
        <p>
        ...
        <p>
          Billing: Subscription fees for the PRO Membership are recurring
          payments (except where identified as otherwise, such as the Lifetime
          Membership and Single Course Purchases). The term may be monthly,
          quarterly, or annual, as described in the course of the transaction.
          Your subscription begins upon payment of the first installment of
          subscription fees. The subscription renews at the specified interval
          as applicable upon the payment of automatically recurring subscription
          fees. Monthly or annual fees are charged on the same day of the month
          that the subscription began. (For example, if a monthly subscription
          begins on the 29th, 30th, or 31st day of a month, then membership will
          renew on the last day of any month that doesn’t have that many days.)
        </p>
        ...
        <p>
          The materials on the GuruCodes.dev website are provided “as is”.
          GuruCodes.dev makes no warranties, expressed or implied, and hereby
          disclaims and negates all other warranties, including without
          limitation, implied warranties or conditions of merchantability,
          fitness for a particular purpose, or non-infringement of intellectual
          property or other violation of rights. Further, GuruCodes.dev does not
        ...
        <p>
          In no event shall gurucodes.dev be liable for any damages (including,
          ...
          materials on the GuruCodes.dev Internet site, even if GuruCodes.dev or
          a GuruCodes.dev authorized representative has been notified orally or
        ...
        <p>
          GuruCodes.dev is committed to protecting intellectual property rights.
          GuruCodes.dev strictly follows DMCA guidelines for unauthorized use of
          copyrighted material. Any inquiries regarding the reproduction of the
          content on this site must be directed to the party holding the
          proprietary rights to the specified content. You shall not distribute,
          publish, transmit, modify, display or create derivative works from
          material obtained with this service. To file a notice of copyright
          infringement with GuruCodes.dev, you will need to provide a written
          communication that follows the guidelines set in Section 512(c)(3) of
